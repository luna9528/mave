...
router.get("/casaca-river", (req, res) => {
  res.render("vermas/casaca-river");
});

router.get("/uefa-europa", (req, res) => {
  res.render("vermas/uefa-europa");
});


router.get("/mia-khalifa", (req, res) => {
  res.render("vermas/mia-khalifa");
});


router.get("/octavo-champions", (req, res) => {
  res.render("vermas/octavos-champions");
});
